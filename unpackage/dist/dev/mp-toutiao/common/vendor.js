...
function initRuntimeSocketService() {
  const hosts = "26.26.26.1,192.168.1.36,127.0.0.1";
  const port = "8090";
  const id2 = "mp-toutiao_oSKXWZ";
...
const b = true, E = "mp-toutiao", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","26.26.26.1","192.168.1.36"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/HBuilderX.4.66.2025051912/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"fengdian-network","spaceId":"mp-1240ebd5-749c-4abc-b593-fd807f0347fb","clientSecret":"O19t2kwfrKNBTMlOW9URcA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__3B0C11F";
} catch (e2) {
