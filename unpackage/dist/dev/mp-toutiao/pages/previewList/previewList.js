  ...
  setup(__props) {
    ...
    async function initialLoadData() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/previewList/previewList.vue:157", "Initial data load failed:", e);
        hasError.value = true;
    ...
    async function loadNav() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/previewList/previewList.vue:181", "加载分类数据失败:", e);
    ...
    async function loadServices() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/previewList/previewList.vue:236", "加载服务列表数据失败:", e);
      ...
      return common_vendor.e({
        a: common_vendor.f(categories.value, (item, index, i0) => {
          return {
            ...
            f: common_vendor.o(($event) => switchCategory(item.type, index))
          };
        }),
        b: scrollLeft.value,
        ...
        i: common_vendor.f(filteredList.value, (item, idx, i0) => {
          return {
            ...
            i: item.id,
            j: common_vendor.o(($event) => navigateDetail(item.id))
          };
        })
      } : {}), {
        f: hasError.value,
...
//# sourceMappingURL=../../../.sourcemap/mp-toutiao/pages/previewList/previewList.js.map
