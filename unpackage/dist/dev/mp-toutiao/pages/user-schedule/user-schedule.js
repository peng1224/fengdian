      ...
      return common_vendor.e({
        ...
        c: common_vendor.f(appointments.value, (item, k0, i0) => {
          return common_vendor.e({
            ...
            k: common_vendor.o(($event) => cancelAppointment(item)),
            l: common_vendor.o(($event) => completeAppointment(item))
          } : item.status === "confirmed" && item.expectedEndTime && item.expectedEndTime <= Date.now() ? {
            n: common_vendor.o(contactCustomerService),
            o: common_vendor.o(($event) => completeAppointment(item))
          } : item.status === "completed" && !item.review ? {
            q: common_vendor.o(contactCustomerService),
            r: common_vendor.o(($event) => openReviewModal(item))
          } : item.status === "completed" && item.review ? {
            t: common_vendor.o(contactCustomerService)
          } : item.status.startsWith("cancelled") && item.refundInfo ? {
            w: common_vendor.o(($event) => viewRefundDetail(item))
          } : {}, {
        ...
        f: common_vendor.f(5, (star, k0, i0) => {
          return {
            ...
            c: common_vendor.o(($event) => setRating(star))
          };
        }),
...
//# sourceMappingURL=../../../.sourcemap/mp-toutiao/pages/user-schedule/user-schedule.js.map
