  ...
  setup(__props) {
    ...
    const fetchAppointmentsForDate = async (date) => {
      ...
      try {
        ...
        if (!workerId)
          throw new Error("无法获取工人ID，请重新登录");
        ...
        common_vendor.index.__f__("error", "at pages/worker-schedule/worker-schedule.vue:220", err);
    ...
    const navigateToLocation = (serviceAddress) => {
      ...
      common_vendor.index.openLocation({
        ...
        fail: (err) => {
          ...
          common_vendor.index.__f__("error", "at pages/worker-schedule/worker-schedule.vue:319", "uni.openLocation failed:", err);
        }
      });
    };
    return (_ctx, _cache) => {
      return common_vendor.e({
        a: common_vendor.f(availableDays.value, (day, index, i0) => {
          return {
            ...
            f: common_vendor.o(($event) => selectDate(day.dateString))
          };
        }),
        ...
        g: common_vendor.f(timeSlots.value, (slot, index, i0) => {
          return common_vendor.e({
            ...
            c: common_vendor.t(slot.isCancelled ? "已取消" : "已预约"),
            d: slot.isCancelled ? 1 : ""
          } : {}, {
            e: index,
            f: slot.isBooked ? 1 : "",
            g: slot.isPast ? 1 : "",
            h: slot.isCancelled ? 1 : "",
            i: common_vendor.o(($event) => selectTimeSlot(slot))
          });
        })
      }, {
...
//# sourceMappingURL=../../../.sourcemap/mp-toutiao/pages/worker-schedule/worker-schedule.js.map
