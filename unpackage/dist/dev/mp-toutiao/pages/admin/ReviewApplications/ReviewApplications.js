      ...
      return {
        a: common_vendor.f(list.value, (item, k0, i0) => {
          return {
            ...
            e: common_vendor.o(($event) => review(item._id, "approve")),
            f: common_vendor.o(($event) => review(item._id, "reject")),
            g: item._id
          };
        })
      };
...
//# sourceMappingURL=../../../../.sourcemap/mp-toutiao/pages/admin/ReviewApplications/ReviewApplications.js.map
