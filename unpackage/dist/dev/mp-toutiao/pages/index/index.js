...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function handleNavClick(categoryId) {
      common_vendor.index.__f__("log", "at pages/index/index.vue:84", "[index] 点击分类，缓存 categoryId=", categoryId);
    ...
    function handleImageError(e) {
      common_vendor.index.__f__("error", "at pages/index/index.vue:92", "图片加载失败", e);
    }
      ...
      return common_vendor.e({
        ...
        f: common_vendor.f(navArr.value, (item, index, i0) => {
          return {
            ...
            c: item._id,
            d: common_vendor.o(($event) => handleNavClick(item._id))
          };
        }),
        g: common_vendor.o(handleImageError),
        h: common_vendor.f(newsArr.value, (item, index, i0) => {
          return {
            a: "35cfa410-0-" + i0,
            b: common_vendor.p({
              item
            ...
            c: item._id,
            d: common_vendor.o(($event) => onNewsClick(item._id, index))
          };
        })
      });
    };
