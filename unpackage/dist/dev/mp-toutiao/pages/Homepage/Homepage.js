    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        c: common_vendor.f(bannerImages.value, (item, index, i0) => {
          return {
            a: item.url,
            b: common_vendor.o(($event) => onBannerTap(index)),
            c: common_vendor.o(($event) => onBannerLongPress(index)),
            d: index
          };
        }),
        ...
        h: common_vendor.f(selectedCategories.value, (item, index, i0) => {
          return {
            ...
            b: common_vendor.o(($event) => removeCategory(index)),
            c: index
          };
        }),
        i: categories.value,
        ...
        D: common_vendor.f(providerShowcase.skills, (skill, index, i0) => {
          return {
            ...
            b: index,
            c: common_vendor.o(($event) => onSkillLongPress(index))
          };
        }),
        ...
        K: common_vendor.f(media.value, (item, index, i0) => {
          return common_vendor.e({
            ...
            e: index,
            f: common_vendor.o(($event) => onMediaLongPress(index))
          });
        }),
...
//# sourceMappingURL=../../../.sourcemap/mp-toutiao/pages/Homepage/Homepage.js.map
